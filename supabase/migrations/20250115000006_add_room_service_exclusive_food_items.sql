/*
  # Add Room Service Exclusive Food Items

  This adds food items that are ONLY available in room service,
...
-- Insert Dinner Items (Room Service Only)
INSERT INTO menu_items (name, description, base_price, category, popular, available, image_url, room_service_only) VALUES
  (
    'Grilled Salmon',
...
-- Insert Snacks & Appetizers (Room Service Only)
INSERT INTO menu_items (name, description, base_price, category, popular, available, image_url, room_service_only) VALUES
  (
    'Nachos Supreme',
...
-- Insert Beverages (Room Service Only)
INSERT INTO menu_items (name, description, base_price, category, popular, available, image_url, room_service_only) VALUES
  (
    'Fresh Orange Juice',
...
-- Insert Desserts (Room Service Only)
INSERT INTO menu_items (name, description, base_price, category, popular, available, image_url, room_service_only) VALUES
  (
    'Chocolate Lava Cake',
